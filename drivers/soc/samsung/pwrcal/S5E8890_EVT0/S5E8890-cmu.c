...
CLK_PLL_NO_TABLE(14160,	MNGS_PLL,	0,	MNGS_PLL_LOCK,	MNGS_PLL_CON0,	MNGS_MUX_MNGS_PLL,	&pll141xx_ops);
CLK_PLL_NO_TABLE(14170,	APOLLO_PLL,	0,	APOLLO_PLL_LOCK,	APOLLO_PLL_CON0,	APOLLO_MUX_APOLLO_PLL,	&pll141xx_ops);
CLK_PLL_NO_TABLE(14180,	G3D_PLL,	0,	G3D_PLL_LOCK,	G3D_PLL_CON0,,	G3D_MUX_G3D_PLL_USER,	&pll141xx_ops);
CLK_PLL_NO_TABLE(14190,	MIF_PLL,	0,	MIF0_PLL_LOCK,	MIF_CLK_CTRL0,	TOP_MUX_MIF_PLL,	&pll1419x_ops);
CLK_PLL_NO_TABLE(14180,	BUS0_PLL,	0,	BUS0_PLL_LOCK,	BUS0_PLL_CON0,	TOP_MUX_BUS0_PLL,	&pll141xx_ops);
CLK_PLL_NO_TABLE(14180,	BUS1_PLL,	0,	BUS1_PLL_LOCK,	BUS1_PLL_CON0,	TOP_MUX_BUS1_PLL,	&pll141xx_ops);
CLK_PLL_NO_TABLE(14180,	BUS2_PLL,	0,	BUS2_PLL_LOCK,	BUS2_PLL_CON0,	TOP_MUX_BUS2_PLL,	&pll141xx_ops);
CLK_PLL_NO_TABLE(14170,	BUS3_PLL,	0,	BUS3_PLL_LOCK,	BUS3_PLL_CON0,	TOP_MUX_BUS3_PLL,	&pll141xx_ops);
CLK_PLL_NO_TABLE(14180,	MFC_PLL,	0,	MFC_PLL_LOCK,	MFC_PLL_CON0,	TOP_MUX_MFC_PLL,	&pll141xx_ops);
CLK_PLL_NO_TABLE(14180,	ISP_PLL,	0,	ISP_PLL_LOCK,	ISP_PLL_CON0,	TOP_MUX_ISP_PLL,	&pll141xx_ops);
CLK_PLL_NO_TABLE(14180,	DISP_PLL,	0,	DISP_PLL_LOCK,	DISP_PLL_CON0,	DISP0_MUX_DISP_PLL,	&pll141xx_ops);
CLK_PLL_NO_TABLE(14310,	AUD_PLL,	0,	AUD_PLL_LOCK,	AUD_PLL_CON0,	AUD_MUX_AUD_PLL_USER,	&pll1431x_ops);
...
static struct pwrcal_clk *fsys0_mux_phyclk_usbhost20_freeclk_user_p[] = {	CLK(OSCCLK),	CLK(PHYCLK_USBHOST20_FREECLK_PHY)	};
static struct pwrcal_clk *fsys0_mux_phyclk_usbhost20_clk48mohci_user_p[] = {	CLK(OSCCLK),	CLK(PHYCLK_USBHOST20_CLK48MOHCI_PHY)	};
...
static struct pwrcal_clk *fsys0_mux_phyclk_ufs_rx_pwm_clk_user_p[] = {	CLK(OSCCLK),	CLK(PHYCLK_UFS_RX_PWM_CLK_PHY)	};
static struct pwrcal_clk *fsys0_mux_phyclk_ufs_tx_pwm_clk_user_p[] = {	CLK(OSCCLK),	CLK(PHYCLK_UFS_TX_PWM_CLK_PHY)	};
static struct pwrcal_clk *fsys0_mux_phyclk_ufs_refclk_out_soc_user_p[] = {	CLK(OSCCLK),	CLK(PHYCLK_UFS_REFCLK_OUT_SOC_PHY)	};
...
static struct pwrcal_clk *fsys1_mux_phyclk_ufs_link_sdcard_rx_pwm_clk_user_p[] = {	CLK(OSCCLK),	CLK(PHYCLK_UFS_LINK_SDCARD_RX_PWM_CLK_PHY)	};
static struct pwrcal_clk *fsys1_mux_phyclk_ufs_link_sdcard_tx_pwm_clk_user_p[] = {	CLK(OSCCLK),	CLK(PHYCLK_UFS_LINK_SDCARD_TX_PWM_CLK_PHY)	};
static struct pwrcal_clk *fsys1_mux_phyclk_ufs_link_sdcard_refclk_out_soc_user_p[] = {	CLK(OSCCLK),	CLK(PHYCLK_UFS_LINK_SDCARD_REFCLK_OUT_SOC_PHY)	};
...
static struct pwrcal_clk *mif0_mux_pclk_mif_p[] = {	CLK(MIF0_MUX_ACLK_MIF_PLL),	CLK(MIF0_FF_ACLK_MIF_PLL_DIV2),	CLK(MIF0_FF_ACLK_MIF_PLL_DIV4),	CLK(U_DFI_CLK_GEN_MIF0)	};
static struct pwrcal_clk *mif0_mux_sclk_hpm_mif_p[] = {	CLK(MIF0_MUX_ACLK_MIF_PLL),	CLK(MIF0_FF_ACLK_MIF_PLL_DIV2),	CLK(MIF0_FF_ACLK_MIF_PLL_DIV4),	CLK(U_DFI_CLK_GEN_MIF0)	};
...
static struct pwrcal_clk *mif1_mux_pclk_mif_p[] = {	CLK(MIF1_MUX_ACLK_MIF_PLL),	CLK(MIF1_FF_ACLK_MIF_PLL_DIV2),	CLK(MIF1_FF_ACLK_MIF_PLL_DIV4),	CLK(U_DFI_CLK_GEN_MIF1)	};
static struct pwrcal_clk *mif1_mux_sclk_hpm_mif_p[] = {	CLK(MIF1_MUX_ACLK_MIF_PLL),	CLK(MIF1_FF_ACLK_MIF_PLL_DIV2),	CLK(MIF1_FF_ACLK_MIF_PLL_DIV4),	CLK(U_DFI_CLK_GEN_MIF1)	};
...
static struct pwrcal_clk *mif2_mux_pclk_mif_p[] = {	CLK(MIF2_MUX_ACLK_MIF_PLL),	CLK(MIF2_FF_ACLK_MIF_PLL_DIV2),	CLK(MIF2_FF_ACLK_MIF_PLL_DIV4),	CLK(U_DFI_CLK_GEN_MIF2)	};
static struct pwrcal_clk *mif2_mux_sclk_hpm_mif_p[] = {	CLK(MIF2_MUX_ACLK_MIF_PLL),	CLK(MIF2_FF_ACLK_MIF_PLL_DIV2),	CLK(MIF2_FF_ACLK_MIF_PLL_DIV4),	CLK(U_DFI_CLK_GEN_MIF2)	};
...
static struct pwrcal_clk *mif3_mux_pclk_mif_p[] = {	CLK(MIF3_MUX_ACLK_MIF_PLL),	CLK(MIF3_FF_ACLK_MIF_PLL_DIV2),	CLK(MIF3_FF_ACLK_MIF_PLL_DIV4),	CLK(U_DFI_CLK_GEN_MIF3)	};
static struct pwrcal_clk *mif3_mux_sclk_hpm_mif_p[] = {	CLK(MIF3_MUX_ACLK_MIF_PLL),	CLK(MIF3_FF_ACLK_MIF_PLL_DIV2),	CLK(MIF3_FF_ACLK_MIF_PLL_DIV4),	CLK(U_DFI_CLK_GEN_MIF3)	};
...
static struct pwrcal_clk *top_mux_aclk_ccore_264_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL),	CLK(TOP_MUX_CP2AP_MIF_CLK_USER)	};
...
static struct pwrcal_clk *top_mux_aclk_ccore_132_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL),	CLK(TOP_MUX_CP2AP_MIF_CLK_USER)	};
static struct pwrcal_clk *top_mux_pclk_ccore_66_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL),	CLK(TOP_MUX_CP2AP_MIF_CLK_USER)	};
...
static struct pwrcal_clk *top_mux_aclk_bus0_200_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_pclk_bus0_132_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
...
static struct pwrcal_clk *top_mux_pclk_bus1_132_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
...
static struct pwrcal_clk *top_mux_aclk_imem_266_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_aclk_imem_200_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_aclk_imem_100_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_aclk_fsys0_200_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_aclk_fsys1_200_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_aclk_peris_66_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_aclk_peric0_66_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_aclk_peric1_66_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
...
static struct pwrcal_clk *top_mux_sclk_disp0_decon0_eclk0_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_disp0_decon0_vclk0_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_disp0_decon0_vclk1_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_disp0_hdmi_audio_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_AUD_PLL)	};
static struct pwrcal_clk *top_mux_sclk_disp1_decon1_eclk0_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_disp1_decon1_eclk1_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_fsys0_usbdrd30_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
...
static struct pwrcal_clk *top_mux_sclk_fsys0_ufsunipro20_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_fsys0_phy_24m_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL)	};
static struct pwrcal_clk *top_mux_sclk_fsys0_ufsunipro_cfg_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
...
static struct pwrcal_clk *top_mux_sclk_fsys1_ufsunipro20_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_fsys1_pcie_phy_p[] = {	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_fsys1_ufsunipro_cfg_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric0_uart0_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric1_spi0_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric1_spi1_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric1_spi2_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric1_spi3_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric1_spi4_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric1_spi5_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric1_spi6_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric1_spi7_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric1_uart1_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric1_uart2_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric1_uart3_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric1_uart4_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_peric1_uart5_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_cam1_isp_spi0_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_cam1_isp_spi1_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
...
static struct pwrcal_clk *top_mux_sclk_promise_int_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
static struct pwrcal_clk *top_mux_sclk_promise_disp_p[] = {	CLK(TOP_MUX_SCLK_BUS0_PLL),	CLK(TOP_MUX_SCLK_BUS1_PLL),	CLK(TOP_MUX_SCLK_BUS2_PLL),	CLK(TOP_MUX_SCLK_BUS3_PLL)	};
...
CLK_MUX(FSYS0_MUX_PHYCLK_USBHOST20_FREECLK_USER,	fsys0_mux_phyclk_usbhost20_freeclk_user_p,	CLK_CON_MUX_PHYCLK_USBHOST20_FREECLK_USER,	12,	1,	CLK_STAT_MUX_PHYCLK_USBHOST20_FREECLK_USER,	12,	2,	CLK_CON_MUX_PHYCLK_USBHOST20_FREECLK_USER,	21,	0);
CLK_MUX(FSYS0_MUX_PHYCLK_USBHOST20_CLK48MOHCI_USER,	fsys0_mux_phyclk_usbhost20_clk48mohci_user_p,	CLK_CON_MUX_PHYCLK_USBHOST20_CLK48MOHCI_USER,	12,	1,	CLK_STAT_MUX_PHYCLK_USBHOST20_CLK48MOHCI_USER,	12,	2,	CLK_CON_MUX_PHYCLK_USBHOST20_CLK48MOHCI_USER,	21,	0);
...
CLK_MUX(FSYS0_MUX_PHYCLK_UFS_RX_PWM_CLK_USER,	fsys0_mux_phyclk_ufs_rx_pwm_clk_user_p,	CLK_CON_MUX_PHYCLK_UFS_RX_PWM_CLK_USER,	12,	1,	CLK_STAT_MUX_PHYCLK_UFS_RX_PWM_CLK_USER,	12,	2,	CLK_CON_MUX_PHYCLK_UFS_RX_PWM_CLK_USER,	21,	0);
CLK_MUX(FSYS0_MUX_PHYCLK_UFS_TX_PWM_CLK_USER,	fsys0_mux_phyclk_ufs_tx_pwm_clk_user_p,	CLK_CON_MUX_PHYCLK_UFS_TX_PWM_CLK_USER,	12,	1,	CLK_STAT_MUX_PHYCLK_UFS_TX_PWM_CLK_USER,	12,	2,	CLK_CON_MUX_PHYCLK_UFS_TX_PWM_CLK_USER,	21,	0);
CLK_MUX(FSYS0_MUX_PHYCLK_UFS_REFCLK_OUT_SOC_USER,	fsys0_mux_phyclk_ufs_refclk_out_soc_user_p,	CLK_CON_MUX_PHYCLK_UFS_REFCLK_OUT_SOC_USER,	12,	1,	CLK_STAT_MUX_PHYCLK_UFS_REFCLK_OUT_SOC_USER,	12,	2,	CLK_CON_MUX_PHYCLK_UFS_REFCLK_OUT_SOC_USER,	21,	0);
...
CLK_MUX(FSYS1_MUX_PHYCLK_UFS_LINK_SDCARD_RX_PWM_CLK_USER,	fsys1_mux_phyclk_ufs_link_sdcard_rx_pwm_clk_user_p,	CLK_CON_MUX_PHYCLK_UFS_LINK_SDCARD_RX_PWM_CLK_USER,	12,	1,	CLK_STAT_MUX_PHYCLK_UFS_LINK_SDCARD_RX_PWM_CLK_USER,	12,	2,	CLK_CON_MUX_PHYCLK_UFS_LINK_SDCARD_RX_PWM_CLK_USER,	21,	0);
CLK_MUX(FSYS1_MUX_PHYCLK_UFS_LINK_SDCARD_TX_PWM_CLK_USER,	fsys1_mux_phyclk_ufs_link_sdcard_tx_pwm_clk_user_p,	CLK_CON_MUX_PHYCLK_UFS_LINK_SDCARD_TX_PWM_CLK_USER,	12,	1,	CLK_STAT_MUX_PHYCLK_UFS_LINK_SDCARD_TX_PWM_CLK_USER,	12,	2,	CLK_CON_MUX_PHYCLK_UFS_LINK_SDCARD_TX_PWM_CLK_USER,	21,	0);
CLK_MUX(FSYS1_MUX_PHYCLK_UFS_LINK_SDCARD_REFCLK_OUT_SOC_USER,	fsys1_mux_phyclk_ufs_link_sdcard_refclk_out_soc_user_p,	CLK_CON_MUX_PHYCLK_UFS_LINK_SDCARD_REFCLK_OUT_SOC_USER,	12,	1,	CLK_STAT_MUX_PHYCLK_UFS_LINK_SDCARD_REFCLK_OUT_SOC_USER,	12,	2,	CLK_CON_MUX_PHYCLK_UFS_LINK_SDCARD_REFCLK_OUT_SOC_USER,	21,	0);
...
CLK_DIV(CAM1_DIV_PCLK_CAM1_SCL_283,	CAM1_MUX_ACLK_CAM1_SCL_566_USER,	CLK_CON_DIV_PCLK_CAM1_SCL_283,	0,	3,	CLK_CON_DIV_PCLK_CAM1_SCL_283,	25,	1,	0);
...
CLK_GATE(BUS0_GATE_ACLK_ACE_FSYS1,	BUS0_MUX_ACLK_BUS0_528_USER,	CLK_ENABLE_ACLK_BUS0_528_BUS0,	8);
CLK_GATE(BUS0_GATE_ACLK_LH_ISP0,	BUS0_MUX_ACLK_BUS0_528_USER,	CLK_ENABLE_ACLK_BUS0_528_BUS0,	7);
CLK_GATE(BUS0_GATE_ACLK_LH_DISP11,	BUS0_MUX_ACLK_BUS0_528_USER,	CLK_ENABLE_ACLK_BUS0_528_BUS0,	6);
CLK_GATE(BUS0_GATE_ACLK_LH_DISP10,	BUS0_MUX_ACLK_BUS0_528_USER,	CLK_ENABLE_ACLK_BUS0_528_BUS0,	5);
CLK_GATE(BUS0_GATE_ACLK_LH_DISP01,	BUS0_MUX_ACLK_BUS0_528_USER,	CLK_ENABLE_ACLK_BUS0_528_BUS0,	4);
CLK_GATE(BUS0_GATE_ACLK_LH_DISP00,	BUS0_MUX_ACLK_BUS0_528_USER,	CLK_ENABLE_ACLK_BUS0_528_BUS0,	3);
CLK_GATE(BUS0_GATE_ACLK_LH_CAM1,	BUS0_MUX_ACLK_BUS0_528_USER,	CLK_ENABLE_ACLK_BUS0_528_BUS0,	2);
CLK_GATE(BUS0_GATE_ACLK_LH_CAM0,	BUS0_MUX_ACLK_BUS0_528_USER,	CLK_ENABLE_ACLK_BUS0_528_BUS0,	1);
CLK_GATE(BUS0_GATE_ACLK_TREX_BUS0,	BUS0_MUX_ACLK_BUS0_528_USER,	CLK_ENABLE_ACLK_BUS0_528_BUS0,	0);
CLK_GATE(BUS0_GATE_ACLK_LH_FSYS1,	BUS0_MUX_ACLK_BUS0_200_USER,	CLK_ENABLE_ACLK_BUS0_200_BUS0,	0);
CLK_GATE(BUS0_GATE_PCLK_TREX_BUS0,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	15);
CLK_GATE(BUS0_GATE_PCLK_PMU_BUS0,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	14);
CLK_GATE(BUS0_GATE_PCLK_SYSREG_BUS0,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	13);
CLK_GATE(BUS0_GATE_PCLK_LH_FSYS1SFRX,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	12);
CLK_GATE(BUS0_GATE_PCLK_LH_PERIC1P,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	11);
CLK_GATE(BUS0_GATE_PCLK_LH_PERIC0P,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	10);
CLK_GATE(BUS0_GATE_PCLK_LH_PERISFRX,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	9);
CLK_GATE(BUS0_GATE_PCLK_LH_DISP1SFRX,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	8);
CLK_GATE(BUS0_GATE_PCLK_LH_DISP0SFRX,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	7);
CLK_GATE(BUS0_GATE_PCLK_LH_ISPHX,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	6);
CLK_GATE(BUS0_GATE_PCLK_LH_IS0X,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	5);
CLK_GATE(BUS0_GATE_PCLK_AXI2APB_2MB_BUS0_TP,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	4);
CLK_GATE(BUS0_GATE_PCLK_AHB2APB_BUS0P,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	3);
CLK_GATE(BUS0_GATE_PCLK_AXI2APB_2MB_BUS0_TD,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	2);
CLK_GATE(BUS0_GATE_PCLK_TREX_P_BUS0,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	1);
CLK_GATE(BUS0_GATE_ACLK_TREX_P_BUS0,	BUS0_MUX_PCLK_BUS0_132_USER,	CLK_ENABLE_PCLK_BUS0_132_BUS0,	0);
CLK_GATE(BUS1_GATE_ACLK_LH_MSCL1,	BUS1_MUX_ACLK_BUS1_528_USER,	CLK_ENABLE_ACLK_BUS1_528_BUS1,	5);
CLK_GATE(BUS1_GATE_ACLK_LH_MSCL0,	BUS1_MUX_ACLK_BUS1_528_USER,	CLK_ENABLE_ACLK_BUS1_528_BUS1,	4);
CLK_GATE(BUS1_GATE_ACLK_LH_MFC1,	BUS1_MUX_ACLK_BUS1_528_USER,	CLK_ENABLE_ACLK_BUS1_528_BUS1,	3);
CLK_GATE(BUS1_GATE_ACLK_LH_MFC0,	BUS1_MUX_ACLK_BUS1_528_USER,	CLK_ENABLE_ACLK_BUS1_528_BUS1,	2);
CLK_GATE(BUS1_GATE_ACLK_LH_FSYS0,	BUS1_MUX_ACLK_BUS1_528_USER,	CLK_ENABLE_ACLK_BUS1_528_BUS1,	1);
CLK_GATE(BUS1_GATE_ACLK_TREX_BUS1,	BUS1_MUX_ACLK_BUS1_528_USER,	CLK_ENABLE_ACLK_BUS1_528_BUS1,	0);
CLK_GATE(BUS1_GATE_PCLK_TREX_BUS1,	BUS1_MUX_PCLK_BUS1_132_USER,	CLK_ENABLE_PCLK_BUS1_132_BUS1,	10);
CLK_GATE(BUS1_GATE_PCLK_SYSREG_BUS1,	BUS1_MUX_PCLK_BUS1_132_USER,	CLK_ENABLE_PCLK_BUS1_132_BUS1,	9);
CLK_GATE(BUS1_GATE_PCLK_PMU_BUS1,	BUS1_MUX_PCLK_BUS1_132_USER,	CLK_ENABLE_PCLK_BUS1_132_BUS1,	8);
CLK_GATE(BUS1_GATE_PCLK_LH_MSCLSFRX,	BUS1_MUX_PCLK_BUS1_132_USER,	CLK_ENABLE_PCLK_BUS1_132_BUS1,	7);
CLK_GATE(BUS1_GATE_PCLK_LH_MFCP,	BUS1_MUX_PCLK_BUS1_132_USER,	CLK_ENABLE_PCLK_BUS1_132_BUS1,	6);
CLK_GATE(BUS1_GATE_PCLK_LH_FSYS0SFRX,	BUS1_MUX_PCLK_BUS1_132_USER,	CLK_ENABLE_PCLK_BUS1_132_BUS1,	5);
CLK_GATE(BUS1_GATE_PCLK_AHB2APB_BUS1P,	BUS1_MUX_PCLK_BUS1_132_USER,	CLK_ENABLE_PCLK_BUS1_132_BUS1,	4);
CLK_GATE(BUS1_GATE_PCLK_AXI2APB_2MB_BUS1_TP,	BUS1_MUX_PCLK_BUS1_132_USER,	CLK_ENABLE_PCLK_BUS1_132_BUS1,	3);
CLK_GATE(BUS1_GATE_PCLK_AXI2APB_2MB_BUS1_TD,	BUS1_MUX_PCLK_BUS1_132_USER,	CLK_ENABLE_PCLK_BUS1_132_BUS1,	2);
CLK_GATE(BUS1_GATE_PCLK_TREX_P_BUS1,	BUS1_MUX_PCLK_BUS1_132_USER,	CLK_ENABLE_PCLK_BUS1_132_BUS1,	1);
CLK_GATE(BUS1_GATE_ACLK_TREX_P_BUS1,	BUS1_MUX_PCLK_BUS1_132_USER,	CLK_ENABLE_PCLK_BUS1_132_BUS1,	0);
...
CLK_GATE(CAM0_GATE_PCLK_TREX_A_5x1_IS_A,	CAM0_DIV_PCLK_CAM0_TREX_132,	CLK_ENABLE_PCLK_CAM0_TREX_132,	2);
...
CLK_GATE(CAM1_GATE_PCLK_SMMU_MC_SC,	CAM1_DIV_PCLK_CAM1_SCL_283,	CLK_ENABLE_PCLK_CAM1_SCL_283,	0);
...
CLK_GATE(CCORE_GATE_ACLK_AXI_AS_SI_IRPM,	CCORE_MUX_ACLK_CCORE_800_USER,	CLK_ENABLE_ACLK_CCORE0,	11);
CLK_GATE(CCORE_GATE_ACLK_MPACEBRIDGE,	CCORE_MUX_ACLK_CCORE_800_USER,	CLK_ENABLE_ACLK_CCORE0,	10);
CLK_GATE(CCORE_GATE_ACLK_PULSE2HS,	CCORE_MUX_ACLK_CCORE_800_USER,	CLK_ENABLE_ACLK_CCORE0,	9);
CLK_GATE(CCORE_GATE_ACLK_DBG_LH_MI_MIF_CCORE,	CCORE_MUX_ACLK_CCORE_800_USER,	CLK_ENABLE_ACLK_CCORE0,	8);
CLK_GATE(CCORE_GATE_ACLK_SCI_PPC_WRAPPER,	CCORE_MUX_ACLK_CCORE_800_USER,	CLK_ENABLE_ACLK_CCORE0,	7);
CLK_GATE(CCORE_GATE_ACLK_ACE_AS_MI_APL_CCORE,	CCORE_MUX_ACLK_CCORE_800_USER,	CLK_ENABLE_ACLK_CCORE0,	6);
CLK_GATE(CCORE_GATE_ACLK_MPACE_SI,	CCORE_MUX_ACLK_CCORE_800_USER,	CLK_ENABLE_ACLK_CCORE0,	5);
CLK_GATE(CCORE_GATE_ACLK_CPACE_MI,	CCORE_MUX_ACLK_CCORE_800_USER,	CLK_ENABLE_ACLK_CCORE0,	4);
CLK_GATE(CCORE_GATE_ACLK_ATB_SI_CCOREBDU_MNGSCS,	CCORE_MUX_ACLK_CCORE_800_USER,	CLK_ENABLE_ACLK_CCORE0,	3);
CLK_GATE(CCORE_GATE_ACLK_BDU,	CCORE_MUX_ACLK_CCORE_800_USER,	CLK_ENABLE_ACLK_CCORE0,	2);
CLK_GATE(CCORE_GATE_ACLK_TREX_CCORE_SCI,	CCORE_MUX_ACLK_CCORE_800_USER,	CLK_ENABLE_ACLK_CCORE0,	1);
CLK_GATE(CCORE_GATE_ACLK_SCI,	CCORE_MUX_ACLK_CCORE_800_USER,	CLK_ENABLE_ACLK_CCORE0,	0);
CLK_GATE(CCORE_GATE_ACLK_ACCESSWINDOW_PERI,	CCORE_MUX_ACLK_CCORE_264_USER,	CLK_ENABLE_ACLK_CCORE1,	10);
CLK_GATE(CCORE_GATE_ACLK_CLEANY_CPPERI,	CCORE_MUX_ACLK_CCORE_264_USER,	CLK_ENABLE_ACLK_CCORE1,	9);
CLK_GATE(CCORE_GATE_ACLK_AXI_US_CPPERI,	CCORE_MUX_ACLK_CCORE_264_USER,	CLK_ENABLE_ACLK_CCORE1,	8);
CLK_GATE(CCORE_GATE_ACLK_AXI_LH_MI_CPPERI_CCORE,	CCORE_MUX_ACLK_CCORE_264_USER,	CLK_ENABLE_ACLK_CCORE1,	7);
CLK_GATE(CCORE_GATE_ACLK_AXI_LH_SI_CCORESFRX_IMEMX,	CCORE_MUX_ACLK_CCORE_264_USER,	CLK_ENABLE_ACLK_CCORE1,	6);
CLK_GATE(CCORE_GATE_ACLK_AXI_LH_MI_G3DXIRAM_CCORESFR,	CCORE_MUX_ACLK_CCORE_264_USER,	CLK_ENABLE_ACLK_CCORE1,	5);
CLK_GATE(CCORE_GATE_ACLK_AXI_DS_IRPM,	CCORE_MUX_ACLK_CCORE_264_USER,	CLK_ENABLE_ACLK_CCORE1,	4);
CLK_GATE(CCORE_GATE_ACLK_XIU_CCORESFRX,	CCORE_MUX_ACLK_CCORE_264_USER,	CLK_ENABLE_ACLK_CCORE1,	3);
CLK_GATE(CCORE_GATE_ACLK_TREX_P_CCORE_BUS,	CCORE_MUX_ACLK_CCORE_264_USER,	CLK_ENABLE_ACLK_CCORE1,	2);
CLK_GATE(CCORE_GATE_ACLK_TREX_CCORE_PERI,	CCORE_MUX_ACLK_CCORE_264_USER,	CLK_ENABLE_ACLK_CCORE1,	1);
CLK_GATE(CCORE_GATE_ACLK_AXI_AS_MI_IRPM,	CCORE_MUX_ACLK_CCORE_264_USER,	CLK_ENABLE_ACLK_CCORE1,	0);
CLK_GATE(CCORE_GATE_ACLK_TREX_CCORE_G3D,	CCORE_MUX_ACLK_CCORE_G3D_800_USER,	CLK_ENABLE_ACLK_CCORE2,	2);
CLK_GATE(CCORE_GATE_ACLK_ACEL_LH_MI_G3DX1_CCORETD,	CCORE_MUX_ACLK_CCORE_G3D_800_USER,	CLK_ENABLE_ACLK_CCORE2,	1);
CLK_GATE(CCORE_GATE_ACLK_ACEL_LH_MI_G3DX0_CCORETD,	CCORE_MUX_ACLK_CCORE_G3D_800_USER,	CLK_ENABLE_ACLK_CCORE2,	0);
CLK_GATE(CCORE_GATE_ACLK_ATB_APL_MNGS,	CCORE_MUX_ACLK_CCORE_528_USER,	CLK_ENABLE_ACLK_CCORE3,	7);
CLK_GATE(CCORE_GATE_ACLK_XIU_CPX,	CCORE_MUX_ACLK_CCORE_528_USER,	CLK_ENABLE_ACLK_CCORE3,	6);
CLK_GATE(CCORE_GATE_ACLK_CLEANY_CPDATA,	CCORE_MUX_ACLK_CCORE_528_USER,	CLK_ENABLE_ACLK_CCORE3,	5);
CLK_GATE(CCORE_GATE_ACLK_AXI_LH_MI_CPDATA_CCORE,	CCORE_MUX_ACLK_CCORE_528_USER,	CLK_ENABLE_ACLK_CCORE3,	4);
CLK_GATE(CCORE_GATE_ACLK_AXI_LH_MI_IMEMX_CCORETD,	CCORE_MUX_ACLK_CCORE_528_USER,	CLK_ENABLE_ACLK_CCORE3,	3);
CLK_GATE(CCORE_GATE_ACLK_AXI_LH_MI_AUDX_CCORETD,	CCORE_MUX_ACLK_CCORE_528_USER,	CLK_ENABLE_ACLK_CCORE3,	2);
CLK_GATE(CCORE_GATE_ACLK_AXI_AS_MI_MNGSCS_CCORETD,	CCORE_MUX_ACLK_CCORE_528_USER,	CLK_ENABLE_ACLK_CCORE3,	1);
CLK_GATE(CCORE_GATE_ACLK_TREX_CCORE,	CCORE_MUX_ACLK_CCORE_528_USER,	CLK_ENABLE_ACLK_CCORE3,	0);
CLK_GATE(CCORE_GATE_PCLK_HPM_APBIF,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	29);
CLK_GATE(CCORE_GATE_PCLK_SCI,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	28);
CLK_GATE(CCORE_GATE_PCLK_GPIO_CCORE,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	27);
CLK_GATE(CCORE_GATE_PCLK_S_MAILBOX,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	26);
CLK_GATE(CCORE_GATE_PCLK_MAILBOX,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	25);
CLK_GATE(CCORE_GATE_PCLK_SYSREG_CCORE,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	24);
CLK_GATE(CCORE_GATE_PCLK_GPIO_APBIF_ALIVE,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	23);
CLK_GATE(CCORE_GATE_PCLK_SCI_PPC_WRAPPER,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	22);
CLK_GATE(CCORE_GATE_PCLK_VT_MON_APB,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	21);
CLK_GATE(CCORE_GATE_PCLK_PMU_CCORE,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	20);
CLK_GATE(CCORE_GATE_PCLK_PMU_APBIF,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	19);
CLK_GATE(CCORE_GATE_PCLK_CMU_TOPC_APBIF,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	18);
CLK_GATE(CCORE_GATE_PCLK_AXI2APB_CORESIGHT,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	17);
CLK_GATE(CCORE_GATE_PCLK_AXI2APB_TREX_P_CCORE,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	16);
CLK_GATE(CCORE_GATE_PCLK_AXI2APB_TREX_CCORE,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	15);
CLK_GATE(CCORE_GATE_PCLK_AXI2APB_CCORE,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	14);
CLK_GATE(CCORE_GATE_PCLK_TREX_P_CCORE,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	13);
CLK_GATE(CCORE_GATE_PCLK_TREX_CCORE,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	12);
CLK_GATE(CCORE_GATE_PCLK_BDU,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	11);
CLK_GATE(CCORE_GATE_ACLK_AXI_LH_SI_CCORETP_MIF3P,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	10);
CLK_GATE(CCORE_GATE_ACLK_AXI_LH_SI_CCORETP_MIF2P,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	9);
CLK_GATE(CCORE_GATE_ACLK_AXI_LH_SI_CCORETP_MIF1P,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	8);
CLK_GATE(CCORE_GATE_ACLK_AXI_LH_SI_CCORETP_MIF0P,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	7);
CLK_GATE(CCORE_GATE_ACLK_AXI_LH_SI_CCORETP_G3DP,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	6);
CLK_GATE(CCORE_GATE_ACLK_AXI_LH_SI_CCORETP_AUDX,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	5);
CLK_GATE(CCORE_GATE_ACLK_AXI_AS_SI_CCORETP_APL,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	4);
CLK_GATE(CCORE_GATE_ACLK_AXI_AS_SI_CCORETP_MNGS,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	3);
CLK_GATE(CCORE_GATE_ACLK_APB_AS_MI_CCORETP_MNGSCS,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	2);
CLK_GATE(CCORE_GATE_ACLK_APB_AS_MI_MNGSCS_CCOREBDU,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	1);
CLK_GATE(CCORE_GATE_ACLK_TREX_P_CCORE,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE4,	0);
CLK_GATE(CCORE_GATE_PCLK_APBASYNC_BAT_AP,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE_AP,	0);
CLK_GATE(CCORE_GATE_PCLK_APBASYNC_BAT_CP,	CCORE_MUX_ACLK_CCORE_132_USER,	CLK_ENABLE_ACLK_CCORE_CP,	0);
CLK_GATE(CCORE_GATE_PCLK_HSI2C_BAT_AP,	CCORE_MUX_PCLK_CCORE_66_USER,	CLK_ENABLE_PCLK_CCORE_AP,	1);
CLK_GATE(CCORE_GATE_PCLK_HSI2C,	CCORE_MUX_PCLK_CCORE_66_USER,	CLK_ENABLE_PCLK_CCORE_AP,	0);
CLK_GATE(CCORE_GATE_PCLK_HSI2C_BAT_CP,	CCORE_MUX_PCLK_CCORE_66_USER,	CLK_ENABLE_PCLK_CCORE_CP,	1);
CLK_GATE(CCORE_GATE_PCLK_HSI2C_CP,	CCORE_MUX_PCLK_CCORE_66_USER,	CLK_ENABLE_PCLK_CCORE_CP,	0);
CLK_GATE(CCORE_GATE_SCLK_PROMISE,	CCORE_MUX_PCLK_CCORE_66_USER,	CLK_ENABLE_SCLK_HPM_CCORE,	0);
...
CLK_GATE(DISP0_GATE_PCLK_VPP0,	DISP0_DIV_PCLK_DISP0_0_133,	CG_CTRL_VAL_PCLK_DISP0_0_133_SECURE_VPP0,	0);
...
CLK_GATE(DISP1_GATE_PCLK_VPP1,	DISP1_DIV_PCLK_DISP1_0_133,	CG_CTRL_VAL_PCLK_DISP1_0_133,	4);
...
CLK_GATE(FSYS0_GATE_HCLK_AHB_ARBITER_USBHS,	FSYS0_MUX_ACLK_FSYS0_200_USER,	CG_CTRL_VAL_ACLK_FSYS0_200,	23);
CLK_GATE(FSYS0_GATE_ACLK_AHB2AXI_USBHS,	FSYS0_MUX_ACLK_FSYS0_200_USER,	CG_CTRL_VAL_ACLK_FSYS0_200,	22);
...
CLK_GATE(FSYS0_GATE_PHYCLK_USBHOST20_FREECLK,	FSYS0_MUX_PHYCLK_USBHOST20_FREECLK_USER,	CG_CTRL_VAL_PHYCLK_USBHOST20_FREECLK,	0);
CLK_GATE(FSYS0_GATE_PHYCLK_USBHOST20_CLK48MOHCI,	FSYS0_MUX_PHYCLK_USBHOST20_CLK48MOHCI_USER,	CG_CTRL_VAL_PHYCLK_USBHOST20_CLK48MOHCI,	0);
CLK_GATE(FSYS0_GATE_PHYCLK_UFS_RX_PWM_CLK,	FSYS0_MUX_PHYCLK_UFS_RX_PWM_CLK_USER,	CG_CTRL_VAL_PHYCLK_UFS_RX_PWM_CLK,	0);
CLK_GATE(FSYS0_GATE_PHYCLK_UFS_TX_PWM_CLK,	FSYS0_MUX_PHYCLK_UFS_TX_PWM_CLK_USER,	CG_CTRL_VAL_PHYCLK_UFS_TX_PWM_CLK,	0);
CLK_GATE(FSYS0_GATE_PHYCLK_UFS_REFCLK_OUT_SOC,	FSYS0_MUX_PHYCLK_UFS_REFCLK_OUT_SOC_USER,	CG_CTRL_VAL_PHYCLK_UFS_REFCLK_OUT_SOC,	0);
...
CLK_GATE(FSYS1_GATE_SCLK_FSYS1_PCIE0_PHY,	FSYS1_MUX_SCLK_FSYS1_PCIE_PHY_USER,	CG_CTRL_VAL_SCLK_FSYS1_PCIE0_PHY,	0);
CLK_GATE(FSYS1_GATE_SCLK_FSYS1_PCIE1_PHY,	FSYS1_MUX_SCLK_FSYS1_PCIE_PHY_USER,	CG_CTRL_VAL_SCLK_FSYS1_PCIE1_PHY,	0);
...
CLK_GATE(FSYS1_GATE_PHYCLK_UFS_LINK_SDCARD_RX_PWM_CLK,	FSYS1_MUX_PHYCLK_UFS_LINK_SDCARD_RX_PWM_CLK_USER,	CG_CTRL_VAL_PHYCLK_UFS_LINK_SDCARD_RX_PWM_CLK,	0);
CLK_GATE(FSYS1_GATE_PHYCLK_UFS_LINK_SDCARD_TX_PWM_CLK,	FSYS1_MUX_PHYCLK_UFS_LINK_SDCARD_TX_PWM_CLK_USER,	CG_CTRL_VAL_PHYCLK_UFS_LINK_SDCARD_TX_PWM_CLK,	0);
CLK_GATE(FSYS1_GATE_PHYCLK_UFS_LINK_SDCARD_REFCLK_OUT_SOC,	FSYS1_MUX_PHYCLK_UFS_LINK_SDCARD_REFCLK_OUT_SOC_USER,	CG_CTRL_VAL_PHYCLK_UFS_LINK_SDCARD_REFCLK_OUT_SOC,	0);
...
CLK_GATE(IMEM_GATE_ACLK_AXI2ACE_BRIDGE,	IMEM_MUX_ACLK_IMEM_266_USER,	CG_CTRL_VAL_ACLK_IMEM_266,	8);
...
CLK_GATE(IMEM_GATE_ACLK_ASYNCAXIM_APM,	IMEM_MUX_ACLK_IMEM_266_USER,	CG_CTRL_VAL_ACLK_IMEM_266,	4);
...
CLK_GATE(IMEM_GATE_PCLK_ASYNCAXI_APM,	IMEM_MUX_ACLK_IMEM_200_USER,	CG_CTRL_VAL_ACLK_IMEM_200,	13);
...
CLK_GATE(IMEM_GATE_ACLK_AHB2AXI_APM,	IMEM_MUX_ACLK_IMEM_100_USER,	CG_CTRL_VAL_ACLK_IMEM_100,	1);
CLK_GATE(IMEM_GATE_ACLK_ASYNCAXIS_APM,	IMEM_MUX_ACLK_IMEM_100_USER,	CG_CTRL_VAL_ACLK_IMEM_100,	0);
...
CLK_GATE(IMEM_GATE_ACLK_ISRAMC_APM,	IMEM_MUX_ACLK_IMEM_100_USER,	CG_CTRL_VAL_ACLK_IMEM_100_SECURE_ISRAMC_APM,	0);
CLK_GATE(IMEM_GATE_ACLK_AHB2APB_BRIDGE_APM,	IMEM_MUX_ACLK_IMEM_100_USER,	CG_CTRL_VAL_ACLK_IMEM_100_SECURE_AHB2APB_BRIDGE_APM,	0);
CLK_GATE(IMEM_GATE_PCLK_MAILBOX_APM,	IMEM_MUX_ACLK_IMEM_100_USER,	CG_CTRL_VAL_ACLK_IMEM_100_SECURE_MAILBOX_APM,	0);
CLK_GATE(IMEM_GATE_PCLK_TIMER_APM,	IMEM_MUX_ACLK_IMEM_100_USER,	CG_CTRL_VAL_ACLK_IMEM_100_SECURE_TIMER_APM,	0);
CLK_GATE(IMEM_GATE_PCLK_WDT_APM,	IMEM_MUX_ACLK_IMEM_100_USER,	CG_CTRL_VAL_ACLK_IMEM_100_SECURE_WDT_APM,	0);
CLK_GATE(IMEM_GATE_PCLK_ISRAMC_SFR_APM,	IMEM_MUX_ACLK_IMEM_100_USER,	CG_CTRL_VAL_ACLK_IMEM_100_SECURE_ISRAMC_SFR_APM,	0);
CLK_GATE(IMEM_GATE_PCLK_SFR_APM,	IMEM_MUX_ACLK_IMEM_100_USER,	CG_CTRL_VAL_ACLK_IMEM_100_SECURE_SFR_APM,	0);
...
CLK_GATE(PERIS_GATE_PCLK_OTP_CON_TOP,	PERIS_MUX_ACLK_PERIS_66_USER,	CG_CTRL_VAL_ACLK_PERIS_SECURE_OTP,	0);
...
CLK_GATE(TOP_GATE_SCLK_BUS_PLL_MIF,	TOP_DIV_SCLK_BUS_PLL_MIF,	CLK_ENABLE_SCLK_BUS_PLL_MIF,	0);
...
CLK_GATE(IMEM_HWACG_APM,	IMEM_MUX_ACLK_IMEM_100_USER,	QSTATE_CTRL_APM,	1);
...
void clk_init(void)
{
	...
	ADD_CLK_TO_LIST(mux_type_list, FSYS0_MUX_PHYCLK_USBHOST20_FREECLK_USER);
	ADD_CLK_TO_LIST(mux_type_list, FSYS0_MUX_PHYCLK_USBHOST20_CLK48MOHCI_USER);
	ADD_CLK_TO_LIST(mux_type_list, FSYS0_MUX_PHYCLK_USBHOST20PHY_REF_CLK);
	ADD_CLK_TO_LIST(mux_type_list, FSYS0_MUX_PHYCLK_UFS_RX_PWM_CLK_USER);
	ADD_CLK_TO_LIST(mux_type_list, FSYS0_MUX_PHYCLK_UFS_TX_PWM_CLK_USER);
	ADD_CLK_TO_LIST(mux_type_list, FSYS0_MUX_PHYCLK_UFS_REFCLK_OUT_SOC_USER);
	...
	ADD_CLK_TO_LIST(mux_type_list, FSYS1_MUX_PHYCLK_UFS_LINK_SDCARD_RX_PWM_CLK_USER);
	ADD_CLK_TO_LIST(mux_type_list, FSYS1_MUX_PHYCLK_UFS_LINK_SDCARD_TX_PWM_CLK_USER);
	ADD_CLK_TO_LIST(mux_type_list, FSYS1_MUX_PHYCLK_UFS_LINK_SDCARD_REFCLK_OUT_SOC_USER);
	...
	ADD_CLK_TO_LIST(div_type_list, CAM1_DIV_PCLK_CAM1_SCL_283);
	...
	ADD_CLK_TO_LIST(gate_type_list, CCORE_GATE_ACLK_ACCESSWINDOW_PERI);
	...
	ADD_CLK_TO_LIST(gate_type_list, CCORE_GATE_SCLK_PROMISE);
	...
	ADD_CLK_TO_LIST(gate_type_list, DISP0_GATE_PCLK_VPP0);
	...
	ADD_CLK_TO_LIST(gate_type_list, DISP1_GATE_PCLK_VPP1);
	...
	ADD_CLK_TO_LIST(gate_type_list, FSYS0_GATE_HCLK_AHB_ARBITER_USBHS);
	ADD_CLK_TO_LIST(gate_type_list, FSYS0_GATE_ACLK_AHB2AXI_USBHS);
	...
	ADD_CLK_TO_LIST(gate_type_list, FSYS0_GATE_PHYCLK_USBHOST20_FREECLK);
	ADD_CLK_TO_LIST(gate_type_list, FSYS0_GATE_PHYCLK_USBHOST20_CLK48MOHCI);
	ADD_CLK_TO_LIST(gate_type_list, FSYS0_GATE_PHYCLK_UFS_RX_PWM_CLK);
	ADD_CLK_TO_LIST(gate_type_list, FSYS0_GATE_PHYCLK_UFS_TX_PWM_CLK);
	ADD_CLK_TO_LIST(gate_type_list, FSYS0_GATE_PHYCLK_UFS_REFCLK_OUT_SOC);
	...
	ADD_CLK_TO_LIST(gate_type_list, FSYS1_GATE_SCLK_FSYS1_PCIE0_PHY);
	ADD_CLK_TO_LIST(gate_type_list, FSYS1_GATE_SCLK_FSYS1_PCIE1_PHY);
	...
	ADD_CLK_TO_LIST(gate_type_list, FSYS1_GATE_PHYCLK_UFS_LINK_SDCARD_RX_PWM_CLK);
	ADD_CLK_TO_LIST(gate_type_list, FSYS1_GATE_PHYCLK_UFS_LINK_SDCARD_TX_PWM_CLK);
	ADD_CLK_TO_LIST(gate_type_list, FSYS1_GATE_PHYCLK_UFS_LINK_SDCARD_REFCLK_OUT_SOC);
	...
	ADD_CLK_TO_LIST(gate_type_list, IMEM_GATE_ACLK_AXI2ACE_BRIDGE);
	...
	ADD_CLK_TO_LIST(gate_type_list, IMEM_GATE_ACLK_ASYNCAXIM_APM);
	...
	ADD_CLK_TO_LIST(gate_type_list, IMEM_GATE_PCLK_ASYNCAXI_APM);
	...
	ADD_CLK_TO_LIST(gate_type_list, IMEM_GATE_ACLK_ASYNCAXIS_APM);
	ADD_CLK_TO_LIST(gate_type_list, IMEM_GATE_ACLK_CM3_APM);
	ADD_CLK_TO_LIST(gate_type_list, IMEM_GATE_ACLK_AHB_BUSMATRIX_APM);
	ADD_CLK_TO_LIST(gate_type_list, IMEM_GATE_ACLK_ISRAMC_APM);
	ADD_CLK_TO_LIST(gate_type_list, IMEM_GATE_ACLK_AHB2APB_BRIDGE_APM);
	ADD_CLK_TO_LIST(gate_type_list, IMEM_GATE_PCLK_MAILBOX_APM);
	ADD_CLK_TO_LIST(gate_type_list, IMEM_GATE_PCLK_TIMER_APM);
	ADD_CLK_TO_LIST(gate_type_list, IMEM_GATE_PCLK_WDT_APM);
	ADD_CLK_TO_LIST(gate_type_list, IMEM_GATE_PCLK_ISRAMC_SFR_APM);
	ADD_CLK_TO_LIST(gate_type_list, IMEM_GATE_PCLK_SFR_APM);
	...
	ADD_CLK_TO_LIST(gate_type_list, PERIS_GATE_PCLK_OTP_CON_TOP);
